...
public class UnmuteCommand extends AxisCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (args.length < 2) {
            ...
            if (punishment == null) {
                sender.sendMessage(ColorText.translate("&c" + target.getName() + " is not muted."));
            } else {
                ...
                punishment.setRemovedReason(reason.toString().replace(" -p", ""));
