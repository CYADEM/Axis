...
public class PermissionAddArgument extends AxisArgument {

    public PermissionAddArgument() {
        super("add");
    }
    ...
    public void onExecute(CommandSender sender, String label, String[] args) {
        if (args.length < 3) {
            ...
            if (!profile.getPermissions().contains(args[2])) {
                profile.getPermissions().add(args[2]);
            }
