...
public class TempBanCommand extends AxisCommand {

    public TempBanCommand() {
        super("tempban", null, "tban");
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (args.length < 3) {
            ...
            if (duration <= 0L) {
                sender.sendMessage(ColorText.translate("&cIf you want to permanently ban a player, use /ban instead."));
            } else {
